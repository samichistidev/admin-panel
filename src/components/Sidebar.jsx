export default function Sidebar({
  ...
  return (
    <div
      className={`bg-gray-800 text-white h-screen p-4 flex flex-col ${collapsed ? "w-fit" : "w-64"} transition-all`}
    >
      <button
      ...
      <ul className="flex flex-col gap-2">
        {menuItems.map((item) => (
          <li key={item.key}>
            <button
              className={`w-full text-left px-2 py-2 gap-3 flex rounded ${
                activePage === item.key
